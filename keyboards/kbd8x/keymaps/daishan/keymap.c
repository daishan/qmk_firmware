...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_tkl_ansi(
      ...
      _______, _______, KC_UP,   _______, _______, _______, _______, KC_PSCR, KC_SLCK, KC_PAUS, _______, _______, _______, _______, _______, _______, _______, \
    ...
    [2] = LAYOUT_tkl_ansi(
      _______,          _______, _______, _______, _______, _______, _______, _______, _______, RGB_VAD, RGB_VAI, RGB_M_R, RGB_TOG, _______, _______, _______, \
      ...
      _______, TG(4),   _______,                   TG(3),                              _______, _______, _______, _______,          KC_WBAK, KC_VOLD, KC_WFWD),
