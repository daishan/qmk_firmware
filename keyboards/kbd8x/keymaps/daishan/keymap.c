...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_tkl_ansi(
      ...
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_EQL,  KC_BSPC, KC_INS,  KC_HOME, KC_PGUP, \
    ...
    [2] = LAYOUT_tkl_ansi(
      ...
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,                   _______, \
      _______, TG(4),   _______,                   TG(3),                              _______, _______, _______, _______,          _______, _______, _______),
