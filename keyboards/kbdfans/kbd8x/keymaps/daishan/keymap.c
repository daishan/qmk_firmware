...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [FN1] = LAYOUT_tkl_ansi(
        ...
        _______,  _______, KC_UP,   _______, _______, _______, _______, KC_PSCR, KC_SLCK, KC_PAUS, _______, _______, _______,  RESET,       _______, _______, _______,
    ...
    [FN2] = LAYOUT_tkl_ansi(
        ...
        _______,    _______, BL_DEC,  BL_TOGG, BL_INC,  BL_STEP, _______, _______, _______, _______, _______,                  _______,              KC_VOLU,
        _______,    TG(CAP),    _______,                      TG(GAM),                      _______,    _______,    _______,   RGB_TOG,     KC_MPRV, KC_VOLD, KC_MNXT),
