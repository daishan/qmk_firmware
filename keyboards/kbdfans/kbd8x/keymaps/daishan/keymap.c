...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [FN1] = LAYOUT_tkl_ansi(
        ...
        _______,  DESKUP,  KC_UP,   DESKDWN, _______, _______, _______, KC_PSCR, KC_SLCK, KC_PAUS, _______, _______, _______,  RESET,       _______, _______, _______,
    ...
    [FN2] = LAYOUT_tkl_ansi(
        ...
        _______,    _______, BL_DEC,  BL_TOGG, BL_INC,  BL_STEP, _______, _______, _______, _______, _______,                  KC_MPLY,              KC_VOLU,
