...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [FN1] = LAYOUT_daishan(
        ...
        _______,   _______,   _______,       _______, _______,        _______, KC_DEL,        _______,   _______,   _______,   _______),
    ...
    [FN2] = LAYOUT_daishan(
        ...
        _______,    _______, BL_DEC,  BL_TOGG, BL_INC,  BL_STEP, _______, _______, _______, _______, _______,        _______,  KC_MPLY,
        _______,   TG(CAP),   _______,       _______, TG(GAM),        _______, _______,       _______,   _______,   _______,   RGB_TOG),
